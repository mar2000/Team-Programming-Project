(function (global) {
    ...
    const coreTools = [
        ...
        {id: "geometry.excircle_touchpoint", commandId: "excircle_touchpoint", label: "Styczność okręgu dopisanego", group: "geometry-tangency", groupLabel: "Styczność", modes: ["geometry", "mixed"], order: 317.987,
            help: "Wybierz okrąg dopisany A/B/C i bok AB/BC/CA, potem kliknij trzy wierzchołki trójkąta."},
        {id: "geometry.incircle_touchpoint", commandId: "incircle_touchpoint", label: "Styczność okręgu wpisanego", group: "geometry-tangency", groupLabel: "Styczność", modes: ["geometry", "mixed"], order: 317.99,
            help: "Wybierz bok AB/BC/CA i kliknij trzy wierzchołki trójkąta."},
